...
const Testimoni: React.FC=()=>{
    useEffect(() => {
        ...
        const handleRightClick = () => {
          const cardWidth = (cardsContainer.firstElementChild as HTMLElement)?.offsetWidth || 0;
          (cardsContainer as HTMLElement).style.transition = 'transform 1s ease-in-out';
          (cardsContainer as HTMLElement).style.transform = `translateX(-${cardWidth}px)`;
          setTimeout(() => {
        ...
        const handleLeftClick = () => {
          const cardWidth = (cardsContainer.lastElementChild as HTMLElement)?.offsetWidth || 0;
          (cardsContainer as HTMLElement).style.transition = 'transform 1s ease-in-out';
          (cardsContainer as HTMLElement).style.transform = `translateX(${cardWidth}px)`;
          setTimeout(() => {
    ...
    return(
        <>
            ...
            <div className="testimoni__content d-flex flex-column">
                ...
                <p className="testimoni__paragraph paragraph-font">Berbagai review positif dari para pelanggan kami</p>
                </div>
                ...
                <div className="card-container d-flex flex-row column-gap-3">
                    ...
                    <div className="testimoni__item d-flex flex-md-row flex-column align-items-center p-3" style={{ backgroundColor: '#F1F3FF' }}>
                    ...
                    <div className="d-flex flex-column testimoni__comment">
                        ...
                        <p className="paragraph-font">“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod”</p>
                ...
                <div className="testimoni__button d-flex flex-row">
                    ...
                    <path d="M13.5 21L18.5 16L13.5 11" stroke="#151515" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    </button>
                </div>
                </div>
